...
std::string tokenToString(const Token &t) {
  ...
  switch (t.kind) {
    ...
    case TokenKind::Tok_Arrow: os << "Arrow"; break;
  ...
  case TokenKind::Tok_PlusAssign: os << "PlusAssign"; break;
  case TokenKind::Tok_Minus: os << "Minus"; break;
  case TokenKind::Tok_MinusMinus: os << "MinusMinus"; break;
  case TokenKind::Tok_MinusAssign: os << "MinusAssign"; break;
  ...
  case TokenKind::Tok_ModulusAssign: os << "ModulusAssign"; break;
  case TokenKind::Tok_PowerAssign: os << "PowerAssign"; break;
  case TokenKind::Tok_NullishCoalescingAssign: os << "NullishCoalescingAssign"; break;
  case TokenKind::Tok_MultiplyAssign: os << "MultiplyAssign"; break;
  ...
  case TokenKind::Tok_Equals: os << "Equals"; break;
  case TokenKind::Tok_IdentityEquals: os << "IdentityEquals"; break;
  case TokenKind::Tok_NotEquals: os << "NotEquals"; break;
  case TokenKind::Tok_IdentityNotEquals: os << "IdentityNotEquals"; break;
  case TokenKind::Tok_BitAnd: os << "BitAnd"; break;
  case TokenKind::Tok_LogicalAnd: os << "LogicalAnd"; break;
  case TokenKind::Tok_BitAndAssign: os << "BitAndAssign"; break;
  case TokenKind::Tok_BitXor: os << "BitXor"; break;
  case TokenKind::Tok_BitXorAssign: os << "BitXorAssign"; break;
  case TokenKind::Tok_BitOr: os << "BitOr"; break;
  case TokenKind::Tok_LogicalOr: os << "LogicalOr"; break;
  case TokenKind::Tok_BitOrAssign: os << "BitOrAssign"; break;
  case TokenKind::Tok_DivideAssign: os << "DivideAssign"; break;
  case TokenKind::Tok_NullLiteral: os << "NullLiteral"; break;
  case TokenKind::Tok_BooleanLiteral: os << "BooleanLiteral"; break;
  case TokenKind::Tok_DecimalLiteral: os << "DecimalLiteral"; break;
  case TokenKind::Tok_BigDecimalIntegerLiteral: os << "BigDecimalIntegerLiteral"; break;
  case TokenKind::Tok_HexIntegerLiteral: os << "HexIntegerLiteral"; break;
  case TokenKind::Tok_BigHexIntegerLiteral: os << "BigHexIntegerLiteral"; break;
  case TokenKind::Tok_OctalIntegerLiteral: os << "OctalIntegerLiteral"; break;
  case TokenKind::Tok_OctalIntegerLiteral2: os << "OctalIntegerLiteral2"; break;
  case TokenKind::Tok_BigOctalIntegerLiteral: os << "BigOctalIntegerLiteral"; break;
  case TokenKind::Tok_BinaryIntegerLiteral: os << "BinaryIntegerLiteral"; break;
  case TokenKind::Tok_BigBinaryIntegerLiteral: os << "BigBinaryIntegerLiteral"; break;
